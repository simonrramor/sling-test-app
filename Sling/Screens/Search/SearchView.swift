...
struct SearchView: View {
    ...
    // Stock definitions - Ondo tokenized stocks
    let stockDefinitions: [(name: String, symbol: String, iconName: String)] = [
        ("Amazon", "AMZNon", "StockAmazon"),
        ("Apple Inc", "AAPLon", "StockApple"),
        ("Coinbase", "COINon", "StockCoinbase"),
        ("Google Inc", "GOOGon", "StockGoogle"),
        ("McDonalds", "MCDon", "StockMcDonalds"),
        ("Meta", "METAon", "StockMeta"),
        ("Microsoft", "MSFTon", "StockMicrosoft"),
        ("Tesla Inc", "TSLAon", "StockTesla"),
        ("Visa", "Von", "StockVisa")
    ]
                        ...
                        if !filteredStocks.isEmpty {
                            ...
                            ForEach(filteredStocks, id: \.symbol) { stock in
                                SearchStockRow(
                                    ...
                                    price: ondoService.tokenData[stock.iconName]?.formattedPrice ?? "—"
                                )
                            }
                        }
