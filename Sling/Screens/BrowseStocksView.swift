...
struct BrowseStocksView: View {
    ...
    // Stock definitions - available stocks to buy
    private let stockDefinitions: [(name: String, iconName: String, description: String)] = [
        ...
        ("Bank of America", "StockBankOfAmerica", "Bank of America is one of the largest financial institutions in the United States."),
        ("Circle", "StockCircle", "Circle is a global financial technology firm and the issuer of USDC stablecoin."),
    ...
    var body: some View {
        ...
        .onAppear {
            Task {
                await stockService.fetchAllStocksForPeriodInParallel(period: "1D")
            }
        }
    }
}
